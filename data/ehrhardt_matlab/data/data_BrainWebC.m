% data_BrainWebC.m
%   data_BrainWebC creates the data set "data_BrainWebC" which is a coronal slice.
%
% See also: 
%
% 2015-10-14 --------------------------------------------------------------
...
mask = imclose(mask,fspecial('disk', 12)>1e-16);
figure(1); clf; imagesc(groundtruth.T1 + mask); axis image; colorbar;
