...
title(string("wL2V proxy (2D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", string(err_proxy)))
axis("off")
savefig("./plots/wL2V2Dprox.png", dpi=300, transparent=false, bbox_inches="tight")
...
title(string("wL2V proj. (2D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", err_proj))
axis("off")
savefig("./plots/wL2V2Dproj.png", dpi=300, transparent=false, bbox_inches="tight")