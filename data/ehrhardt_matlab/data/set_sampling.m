...
options.mri.sampling.cartesianX_1d4.coverage = round(options.mri.objectsize_in_pixel .* [1 1./4]);

options.mri.sampling.cartesianX3.coverage = options.mri.objectsize_in_pixel;
options.mri.sampling.cartesianX3.every_nth_line = 3;
options.mri.sampling.cartesianX3.center_block = center_block;
...
data.mri.freq.cartesianX_1d4 = MRI2_sample_cartesian_x_standard(options.mri.sampling.cartesianX_1d4.coverage);
data.mri.freq.cartesianX3 = MRI2_sample_cartesian_x_standard(options.mri.sampling.cartesianX3.coverage, [], options.mri.sampling.cartesianX3.every_nth_line);
data.mri.freq.cartesianX3 = [data.mri.freq.cartesianX3 MRI2_sample_cartesian_x_standard(options.mri.sampling.cartesianX3.center_block)];
...
options.mri.sampling.cartesianY4.coverage = options.mri.objectsize_in_pixel;
options.mri.sampling.cartesianY4.every_nth_line = 4;
options.mri.sampling.cartesianY4.center_block = center_block;

options.mri.sampling.cartesianY6.coverage = options.mri.objectsize_in_pixel;
options.mri.sampling.cartesianY6.every_nth_line = 6;
options.mri.sampling.cartesianY6.center_block = center_block;

data.mri.freq.cartesianY4 = MRI2_sample_cartesian_y_standard(options.mri.sampling.cartesianY4.coverage, [], options.mri.sampling.cartesianY4.every_nth_line);
data.mri.freq.cartesianY4 = [data.mri.freq.cartesianY4 MRI2_sample_cartesian_y_standard(options.mri.sampling.cartesianY4.center_block)];
data.mri.freq.cartesianY6 = MRI2_sample_cartesian_y_standard(options.mri.sampling.cartesianY6.coverage, [], options.mri.sampling.cartesianY6.every_nth_line);
data.mri.freq.cartesianY6 = [data.mri.freq.cartesianY6 MRI2_sample_cartesian_y_standard(options.mri.sampling.cartesianY6.center_block)];

% cartesian random x
cart_random = [0 8; 0 8; 0 16; 0 32; 0 64];
...
% cartesian random y
cart_random = [0 8; 0 16; 0 32; 0 64];
for i = 1 : size(cart_random,1)
...
options.mri.sampling.spiral16.n_turns = 2;
...
options.mri.sampling.spiral8.n_turns = 2;
...
options.mri.sampling.spiral4.n_turns = 7;
...
options.mri.sampling.spiral2.n_turns = 10;
...
options.mri.sampling.spiralPhyll1.density = .3;
...
options.mri.sampling.spiralPhyll2.density = .4;
