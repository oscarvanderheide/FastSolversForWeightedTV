% data_BrainWebB.m
%   data_BrainWebB creates the data set "data_BrainWebB" which is a transverse slice.
%
% See also: 
%
% 2015-10-14 --------------------------------------------------------------
...
%%
mask = groundtruth.T2 > .05;
mask = imclose(mask,fspecial('disk', 10)>1e-16);
