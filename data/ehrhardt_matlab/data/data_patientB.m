% data_patientB.m
%   data_patientB creates the data set "patientB" which is a sagital slice.
%
% See also: 
%
% 2015-10-14 --------------------------------------------------------------
...
mask = imdilate(mask,Gaussian([9 9], [31 31], [1 1])>.006);
mask = imclose(mask,Gaussian([9 9], [31 31], [1 1])>.002);
