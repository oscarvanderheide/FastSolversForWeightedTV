...
# TV norm
g = LInfV_norm_3D(n; weight=P) |> gpu
ε_orig = g(y_orig)
...
title(string("wLInfV proxy (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", string(err_proxy)))
axis("off")
savefig("./plots/wLInfV3Dprox.png", dpi=300, transparent=false, bbox_inches="tight")
...
title(string("wLInfV proj. (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", err_proj))
axis("off")
savefig("./plots/wLInfV3Dproj.png", dpi=300, transparent=false, bbox_inches="tight")