function [err, conv, time, sol, param, parts, all] = Parameter_estimation(...
        fun, fun_err, parallel, varargin)
...
%       solution operator
%
%   fun_err [function handle]
%       error function to rate solution
%
%   parallel [int] 
%       number of workers
%
