...
title(string("L2V proxy (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", string(err_proxy)))
axis("off")
savefig("./plots/L2V3Dprox.png", dpi=300, transparent=false, bbox_inches="tight")
...
title(string("L2V proj. (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", string(err_proj)))
axis("off")
savefig("./plots/L2V3Dproj.png", dpi=300, transparent=false, bbox_inches="tight")