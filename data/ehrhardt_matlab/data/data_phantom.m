% data_phantom.m
%   data_phantom creates the data set "data_phantom"
%
% See also: 
%
% 2015-10-14 --------------------------------------------------------------
...
%% 
mask = groundtruth.T1 > .01;
mask = imdilate(mask,Gaussian([5 5], [15 15], [1 1])>.005);
mask = imclose(mask,Gaussian([11 1], [31 31], [1 1])>.04);
mask(60:200,60:200) = 1;
mask(100:150,40:200) = 1;
