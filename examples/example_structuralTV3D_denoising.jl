...
title(string("wTV proxy (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", string(err_proxy)))
axis("off")
savefig("./plots/wTV3Dprox.png", dpi=300, transparent=false, bbox_inches="tight")
...
title(string("wTV proj. (3D), ", L"$\mathrm{err}_{\mathrm{rel}}$ = ", err_proj))
axis("off")
savefig("./plots/wTV3Dproj.png", dpi=300, transparent=false, bbox_inches="tight")