function freq = MRI2_sample_cartesian_x_standard(s_kspace, n_readouts, phase_jump, phase_offset)
% MRI2_sample_cartesian_x_standard
%   freq = MRI2_sample_cartesian_x_standard(s_kspace, n_readouts, i_phaseencodes) samples 
